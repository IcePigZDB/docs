...
Use this command to query all Regions in a given range [startkey, endkey). It supports range without endKey, the default value of limit is `16`,  set to `-1` for unlimited. 
...
>> region keys --format=raw a z      // Display all Regions in range [a, z) with default limit count 16
{
  "count": 16,
  "regions": [......],
}

>> region keys --format=raw a z -1   // Display all Regions in range [a, z) without limit
{
  "count": ...,
  "regions": [......],
}
